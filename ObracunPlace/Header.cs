...
// Fields...
    public override void OnEndPage(PdfWriter writer, Document document)
    {
      ...
      var celijakutina = new PdfPCell(kutina) {HorizontalAlignment = Element.ALIGN_LEFT, Border = Rectangle.NO_BORDER};
      var datum = new Phrase(DateTime.Now.Date.ToString("d"), times);
      var celijadatum = new PdfPCell(datum) {HorizontalAlignment = Element.ALIGN_LEFT, Border = Rectangle.NO_BORDER};
