    ...
    private void Ispis_Click(object sender, RoutedEventArgs e)
    {
      ...
      using (var doc = new Document(PageSize.A4, 20, 15, 25, 30))
      {
        try
        {
          ...
          doc.Add(listaIznosa);
          doc.Add(
            new Paragraph("Obračun izradio: ", times) {SpacingBefore = 10f, Alignment = 2, IndentationRight = 80f});
        ...
        {
          MessageBox.Show("Došlo je do pogreške, zatvorite otvoren .pdf dokument!", "Pozor", MessageBoxButton.OK
