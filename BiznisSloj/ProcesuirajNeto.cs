...
namespace BiznisSloj
{
  public class ProcesuirajNeto
  {
    ...
    private void NadjiMetoduZaIzracun(decimal neto, decimal odbitak)
    {
      ...
      else if (neto < PorezMax - PorKoef24 * KoefPrireza + odbitak) Bruto = Math.Round(DrugaMetoda(neto, odbitak), 2);
      else if (neto > PorezMax - PorKoef24 * KoefPrireza + odbitak) Bruto = Math.Round(TrecaMetoda(neto, odbitak), 2);
    }
