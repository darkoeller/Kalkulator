...
namespace BiznisSloj
{
    public static class Prijevoz
    {
        private static readonly Dictionary<string, decimal> ListaRelacija = new Dictionary<string, decimal>()
        {
            ...
            {"Donja Vlahinička - Kutina", 657.8m},
