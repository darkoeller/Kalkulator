    ...
    public class Koeficijenti
    {
        ...
        public static IEnumerable<Koeficijenti> VratiSifre()
        {
            var sifreRada = new List<Koeficijenti>
            {
                ...
                new Koeficijenti {Id = 16, Sifra = "05", Naziv = @"Prekovremeni rad blagdan ned. 1.smjena", Koeficijent = 2.35m},
                new Koeficijenti {Id = 17, Sifra = "05", Naziv = @"Prekovremeni rad blagdan ned. 2.smjena", Koeficijent = 2.50m},
                ...
                new Koeficijenti {Id = 32, Sifra = "09", Naziv = @"Naknada za G.O. blagdan ned. 1.smjena", Koeficijent = 1.80m},
                new Koeficijenti {Id = 33, Sifra = "09", Naziv = @"Naknada za G.O. blagdan ned. 2.smjena", Koeficijent = 2.00m},
                ...
                new Koeficijenti {Id = 39, Sifra = "11", Naziv = @"Naknada za pl.dopust nedjeljom 1.smjena", Koeficijent = 1.35m},
                new Koeficijenti {Id = 40, Sifra = "11", Naziv = @"Naknada za pl.dopust nedjeljom 2.smjena", Koeficijent = 1.50m},
                new Koeficijenti {Id = 41, Sifra = "11", Naziv = @"Naknada za pl.dopust nedjeljom noću", Koeficijent = 1.85m},
                new Koeficijenti {Id = 42, Sifra = "11", Naziv = @"Naknada za pl.dopust blagdan 1.smjena", Koeficijent = 1.50m},
                new Koeficijenti {Id = 43, Sifra = "11", Naziv = @"Naknada za pl.dopust blagdan 2.smjena", Koeficijent = 1.65m},
