        ...
        public static IEnumerable<Koeficijenti> VratiSifre()
        {
            var sifreRada = new ObservableCollection<Koeficijenti>
            {
                ...
                new Koeficijenti
                {
                    Id = 10,
                    Sifra = "05",
                    Naziv = @"Prekovremeni rad nedjeljom 1.smjena",
                    Koeficijent = 1.85m
                },
                new Koeficijenti
                {
                    Id = 11,
                    Sifra = "05",
                    Naziv = @"Prekovremeni rad nedjeljom 2.smjena",
                    Koeficijent = 2.00m
                },
                new Koeficijenti
                {
                    Id = 12,
                    Sifra = "05",
                    Naziv = @"Prekovremeni rad nedjeljom noću",
                    Koeficijent = 2.35m
                },
                new Koeficijenti
                {
                    Id = 13,
                    Sifra = "05",
                    Naziv = @"Prekovremeni rad blagdan 1.smjena",
                    Koeficijent = 2.00m
                },
                new Koeficijenti
                {
                ...
                new Koeficijenti
                {
                    Id = 26,
                    Sifra = "09",
                    Naziv = @"Naknada za G.O. nedjeljom 1.smjena",
                    Koeficijent = 1.35m
                },
                new Koeficijenti
                {
                    Id = 27,
                    Sifra = "09",
                    Naziv = @"Naknada za G.O. nedjeljom 2.smjena",
                    Koeficijent = 1.50m
                },
                new Koeficijenti
                {
                    Id = 28,
                    Sifra = "09",
                    Naziv = @"Naknada za G.O. nedjeljom noću",
                    Koeficijent = 1.85m
                },
                new Koeficijenti
                {
                    Id = 29,
                    Sifra = "09",
                    Naziv = @"Naknada za G.O. blagdan 1.smjena",
                    Koeficijent = 1.50m
                },
                new Koeficijenti
                {
                ...
                new Koeficijenti
                {
                    Id = 41,
                    Sifra = "11",
                    Naziv = @"Naknada za pl.dopust nedjeljom noću",
                    Koeficijent = 1.85m
                },
                new Koeficijenti
                {
                ...
                new Koeficijenti
                {
                    Id = 44,
                    Sifra = "11",
                    Naziv = @"Naknada za pl.dopust blagdan noću",
                    Koeficijent = 2.00m
                },
                new Koeficijenti
                {
                    Id = 45,
                    Sifra = "32",
                    Naziv = @"Rad na blagdan nedjeljom 1.smjena",
                    Koeficijent = 1.80m
                },
                new Koeficijenti
                {
